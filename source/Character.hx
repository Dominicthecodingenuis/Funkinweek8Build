	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
		    ...
		    case 'darnell':
				...
				frames = tex;
		        animation.addByPrefix('danceRight', 'beepboop', 24);
				animation.addByPrefix('danceLeft', 'beepboop', 24);

				addOffset("danceRight", 0, 8);
				addOffset("danceLeft", 6, 12);

				playAnim('danceRight');

				case 'pico-player':
				tex = Paths.getSparrowAtlas('Characters/pico-player');
				frames = tex;
				animation.addByPrefix('idle', "Pico Idle Dance", 24);
				animation.addByPrefix('singUP', 'pico Up note0', 24, false);
				animation.addByPrefix('singDOWN', 'Pico Down Note0', 24, false);
        ...
        addOffset("singDOWNmiss", 80, -38);
				...
				frames = tex;
		        animation.addByPrefix('danceRight', 'GF Dancing at Gunpoint', 24);
				animation.addByPrefix('sad', 'GF Crying at Gunpoint', 24);
